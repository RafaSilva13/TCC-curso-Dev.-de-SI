    ...
    <table class="table table-striped table-bordered" style="margin-bottom: 0;">
        ...
        <thead class="table-dark" style="border-radius: 20px;">
            ...
            <tr>
                ...
                <th class="th" style="width: 6.2rem;">Cliente</th>
                <th class="th" style="width: 22rem;">Endereço</th>
                <th class="th" style="width: 7rem;">Data</th>
                <th class="th" style="width: 4rem;">Tempo</th>
                <th class="th" style="width: 4rem;">Distância</th>
                <th class="th" style="width: 5.5rem;">Peso</th>
            ...
            <tbody>
                ...
                ?> 
                    <tr>
                        ...
                        <td style="width: 8rem;"><?php echo $value[4]; echo " min"?></td>
                        
                        <td style="width: 10rem;"><?php echo  $value[6]; echo " km" ?></td>
                        
                        <td style="width: 6rem;"><?php echo   $value[5]; ?></td>
