    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: 1rem;">
            ...
            <div class="col">
                ...
                <div class="col-lg-4" id="fundoCadastroCliente">
                    ...
                    <form id="formCadastroCliente">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col">
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <input type="password" id="senhaCliente2" name="cad_senha" class="form-control" required>
                                
                                    <label class="form-label" for="senhaCliente2" style="margin-left: 0px;">Senha</label>
                            ...
                            <div class="col">
                                ...
                                <div class="form-outline mb-3">
                                    ...
                                    <input type="password" id="senhaCliente3" class="form-control" required>
                                    
                                    <label class="form-label" for="senhaCliente3" style="margin-left: 0px;">Repita a senha</label>
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-1" style="margin-top: 10px;font-size:16px;">Já possui uma conta? <a href="<?= site_url('Geral/loginCliente')?>">Fazer Login</a></p>
